...
export function OneMinuteCheck() {
  ...
  return <section className="challenge-section" id="one-minute-check" aria-labelledby="prediction-title">
    <div className="challenge-copy"><p className="eyebrow">One-minute check</p><h2 id="prediction-title">How similar can five keys be?</h2><p>We store A as amber and two other keys as violet. Amber contributes 1; the two violet contributions add up. At what overlap do they tie? Predict without rotation first, then compare with the rotated calculation.</p></div>
